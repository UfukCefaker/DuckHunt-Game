...
public class Level4 {
    ...
    /**
     * This function will be used for moving the 2 bird with respect to dx1,dx2,dy1 and dy2.
     * @param stage of game.
     */
    ...
    public void addingTable(Pane root){
        Text level4Text = new Text();
        level4Text.setText("LEVEL 4/6       AMMO LEFT: "+Integer.toString(ammoLeft));

        level4Text.setFont(Font.font("White",20));
        level4Text.setFill(Color.WHITE);
        VBox vbox = new VBox(level4Text);
        vbox.setTranslateX(100);
        vbox.setTranslateY(30);
        this.level4Text = vbox;
