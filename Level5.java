...
public class Level5 {
    ...
    /**
     * This function will be used for moving the 3 bird with respect to dx1,dx2,dx3 and dy3.
     * @param stage of game.
     */
    ...
    public void addingTable(Pane root){
        Text level5Text = new Text();
        level5Text.setText("LEVEL 5/6       AMMO LEFT: "+Integer.toString(ammoLeft));

        level5Text.setFont(Font.font("White",20));
        level5Text.setFill(Color.WHITE);
        VBox vbox = new VBox(level5Text);
        vbox.setTranslateX(100);
        vbox.setTranslateY(30);
        this.level5Text = vbox;
